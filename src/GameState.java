...
//TODO shortlist 1: fix rankhands bug 2: debug amount to call in playerStackLabel 3: implement call method (done?) 4: implement input getting in raise method

//TODO reminders: make all buttons appear the same width?, find a mechanism to end game with win screen, make blinds, show a dealer, updates shown on screen (including amount to call, remaining players)
...
public class GameState extends Application {
    ...
    private VBox privacyScreen = new VBox(325);
    ...
    private Button endGameButton = new Button("End Game");//TODO implement this button

    private Text potLabel = new Text("Current Pot: " + pot);

    private VBox playerInfoBox = new VBox();

    private Label playerStackLabel = new Label();
    ...
    private HBox multiplePlayerInfoBox = new HBox(30);
        ...
        startNewGameButton.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                try {
                    ...
                    showTableCards();
                    showStateOfGameDisplayTableCards();
        ...
        call.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                ...
                if (call <= currentPlayer.getChipCount()) {
                    ...
                    //TODO special case of going all in
                }
                if (lastPlayerToRaise == nextPlayer) {
                    nextRound();
                } else {
    ...
    private void drawNextTurn() {
        ...
        //inter turn screen
        privacyScreenTitle.setText("It's Player " + (playerList.indexOf(currentPlayer) + 1) + "'s Turn");
        primary.setScene(privacyScreenScene);
        primary.show();
        //
    ...
    public void nextRound() {
        ...
        if (round < 3) {
            ...
            //TODO if someone wins the game, end the game
            //reset round, determine winners, and split up the pot
            round = 0;
            deck.resetDeck();//TODO try to cut
